...
urlpatterns = [
    ...
    path('payments/verify/<str:reference>/', views.ChapaPaymentVerifyView.as_view(), name='chapa-payment-verify'),
    path('health/', views.ServiceHealthCheck.as_view(), name='health-check'),
